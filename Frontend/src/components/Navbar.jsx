        ...
        <nav className='container mx-auto flex items-center justify-between p-5'>
          <div>
            <Link to='/' className='text-blue-600 font-bold text-xl'>
              Job<span className='text-[#1677cccb]'>Connect</span>
            </Link>
          </div>
          ...
          <ul className='hidden lg:flex gap-10 text-base'>
            ...
            <li>
              <Link to={user?.accountType === "seeker"? "/get-application":'/upload-job'}>{user?.accountType === "seeker"? "My Applications":" Upload Job"}</Link>
            </li>
            <li>
