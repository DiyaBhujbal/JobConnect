...
const UserForm = ({ open, setOpen }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const url = uploadCv && (await handleFileUpload(uploadCv));

      const newData = uri ? { ...data , profileUrl : uri ,cvUrl : uri} : data;
      // const newdata = uri ? { ...data, cvUrl : uri } : data;
      ...
      // if (resp){
      //   const newdata = {token: resp?.token, ...resp?.user};
        ...
        <div className='w-full py-10'>
          <div className='w-full flex flex-col-reverse md:flex-row gap-8 py-6'>
            ...
            <div className='w-full md:w-1/3 h-44'>
              ...
              />
              <button
                className='w-full md:w-55 bg-blue-600 text-white mt-4 py-2 rounded'
